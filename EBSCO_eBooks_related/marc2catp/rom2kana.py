# coding: utf-8
#
# http://d.hatena.ne.jp/mohayonao/20091129/1259505966 より引用した
# コードに 'ā' 以下を追加
#
...
def _make_romaji_convertor():
    ...
    master = {
        ...
        'ā':'アー', 'kā':'カー', 'sā':'サー', 'tā':'ター', 'nā':'ナー',
        'hā':'ハー', 'mā':'マー', 'yā':'ヤー', 'rā':'ラー', 'wā':'ワー',
        'gā':'ガー', 'zā':'ザー', 'dā':'ダー', 'bā':'バー', 'pā':'パー',
        'fā':'ファー', 'jā':'ジャー', 'chā':'チャー', 'gyā':'ギャー',
        'vā':'ヴァー', 'shā':'シャー',
        
        'ī':'イー', 'kī':'キー', 'sī':'シー', 'shī':'シー', 'tī':'チー',
        'chī':'チー', 'nī':'ニー', 'hī':'ヒー', 'mī':'ミー', 'rī':'リー',
        'wī':'ウィー', 'gī':'ギー', 'zī':'ズー', 'dī':'ディー', 'bī':'ビー',
        'pī':'ピー', 'jī':'ジー', 'fī':'フィー', 'lī':'リー',
        
        'ū':'ウー', 'kū':'クウ', 'sū':'スウ', 'tsū':'ツウ', 'nū': 'ヌウ',
        'hū':'フー', 'mū':'ムウ', 'yū':'ユウ', 'rū':'ルウ',
        'wū':'ウー', 'gū':'グー', 'zū':'ズー', 'dū':'ドゥー', 'bū':'ブー',
        'pū':'プー', 'kyū':'キュー', 'shū':'シュウ', 'chū':'チュー',
        'nyū':'ニュー', 'hyū':'ヒュー', 'fū':'フー', 'myū':'ミュー',
        'ryū':'リュウ', 'gyū':'ギュー',
        'jū':'ジュー', 'pyū':'ピュー', 'jyū':'ジュー', 'byū':'ビュー',
        'vū':'ヴュー',
        
        'ē':'エー', 'kē':'ケー', 'sē':'セー', 'tē':'テー', 'nē':'ネー',
        'hē':'ヘー', 'mē':'メー', 'rē':'レー', 'gē':'ゲー', 'zē':'ゼー',
        'dē':'デー', 'bē':'ベー', 'pē':'ペー', 'fē':'フェー',
        'chē':'チェー', 'wē':'ウェー', 'vē':'ヴェー', 'shē':'シェー',
        
        'ō':'オウ', 'kō':'コウ', 'sō':'ソウ', 'tō':'トウ', 'nō':'ノウ',
        'hō':'ホウ', 'mō':'モウ', 'yō':'ヨウ', 'rō':'ロウ', 'wō':'ヲォー',
        'gō':'ゴウ', 'zō':'ゾウ', 'dō':'ドウ', 'bō':'ボウ', 'pō':'ポウ',
        'vō':'ヴォー', 'fō':'フォー', 'kyō':'キョウ', 'shō':'ショウ',
        'syō':'ショウ', 'chō':'チョウ', 'tyō':'チョウ', 'nyō':'ニョウ',
        'hyō':'ヒョウ', 'myō':'ミョウ', 'ryō':'リョウ', 'gyō':'ギョウ',
        'jō':'ジョウ', 'zyō':'ジョウ', 'dyō':'ヂョウ', 'byō':'ビョウ',
        'pyō':'ピョウ',
